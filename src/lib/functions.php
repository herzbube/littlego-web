...
<body>
    ...
    <div id="move-is-illegal-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="move-is-illegal-modal-label" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="move-is-illegal-modal-label">Move is illegal</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>You can't play on <span id="move-is-illegal-modal-intersection"></span>.</p>
                    <p>Reason: <span id="move-is-illegal-modal-reason"></span>!</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
