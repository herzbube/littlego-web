// ----------------------------------------------------------------------
// This file contains generic library code for drawing a Go board.
//
// The BoardViewMetrics class was lifted from the Little Go project (from
// the same author as this project) and transcribed from Objective-C into
// JavaScript.
//
// In addition there are a number of compatibility classes and functions that
// emulate iOS' CoreGraphics structs and functions. We need these so that we
// can reuse a lot of the drawing code from the Little Go iOS project.
// ----------------------------------------------------------------------
